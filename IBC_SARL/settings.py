"""
Django settings for IBC_SARL project.
...
WSGI_APPLICATION = 'IBC_SARL.wsgi.application'
...
# CSRF : origines autorisées (évite 403 en dev / proxy)
...
# Authentication Backend personnalisé pour permettre la connexion avec email
AUTHENTICATION_BACKENDS = [
    'website.backends.EmailBackend',  # Notre backend personnalisé
